<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="#">
        <img class="navbar-brand-dark" src="{{ asset($settings['site_logo']) }}" alt="Volt logo" /> <img
            class="navbar-brand-light" src="{{ asset($settings['site_logo']) }}" alt="Volt logo" />
    </a>
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="{{ route('dashboard') }}" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="{{ asset($settings['site_logo']) }}" height="30" width="30" alt="Volt Logo">
                    </span>
                    <span class="mt-1 ms-1 sidebar-text">RSF Israel</span>
                </a>
            </li>
            ...
            <li class="nav-item {{ request()->routeIs('accessibilities.*') ? 'active' : '' }}">
                <a href="{{ route('accessibilities.index') }}" class="nav-link">
                    ...
                    <span class="sidebar-text">Accessibility</span>
                </a>
            </li>
            <li class="nav-item  {{ request()->routeIs('emails.index') ? 'active' : '' }}">
                <a href="{{ route('emails.index') }}" class="nav-link">
                    ...
                    <span class="sidebar-text">E-mail</span>
                </a>
            </li>
            <li class="nav-item">
